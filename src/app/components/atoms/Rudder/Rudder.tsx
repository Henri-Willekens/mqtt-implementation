...
const Rudder: React.FC<RudderProps> = ({ id, totalRudderAngle, width, height, activePageId, configEnabled }) => {
    ...
    <>
      <div key={id} onDoubleClick={openModal}>
        <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
          ...
          <g className='boat'>
            <path className='boat-fill' fill-rule='evenodd' clip-rule='evenodd' d='M101 17.4787V133C101 135.761 103.239 138 106 138H140C142.761 138 145 135.761 145 133V17.4787C137.97 15.208 130.598 14 123 14C115.402 14 108.03 15.208 101 17.4787Z' />
          ...
          <defs>
            <linearGradient id='paint0_linear_1037_1650' x1='125' y1='24' x2='125' y2='226' gradientUnits='userSpaceOnUse'>
              <stop stop-color='#7474B9' />
              <stop offset='1' stop-color='#343453' />
            </linearGradient>
